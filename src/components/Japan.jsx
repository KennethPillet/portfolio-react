...
export class Japan extends React.Component{
    ...
    <main onClick={ this.props.goBack }>
        ...
        <div class="container">
            ...
            <img src="img/voyage/mandarakeNakanoBroadway.jpeg" class="inline-photo show-on-scroll"alt="" />
            <div class="descr">
                <h3>Lorem ipsum dolor sit amet.</h3>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magnam, praesentium! Est nostrum hic magnam modi repellendus pariatur numquam eius incidunt quia eligendi molestias, expedita quam cupiditate fugiat dolorum. Reiciendis, blanditiis!</p>
            </div>
            ...
            <img src="img/voyage/Fushimi-inari-Bro&I.jpg" class="inline-photo show-on-scroll"alt="" />
            <div class="descr">
                <h3>Lorem ipsum dolor sit amet.</h3>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magnam, praesentium! Est nostrum hic magnam modi repellendus pariatur numquam eius incidunt quia eligendi molestias, expedita quam cupiditate fugiat dolorum. Reiciendis, blanditiis!</p>
            </div>
            <img src="img/voyage/kinkakuji.jpeg" class="inline-photo show-on-scroll"alt="" />
            <div class="descr">
                <h3>Lorem ipsum dolor sit amet.</h3>
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Magnam, praesentium! Est nostrum hic magnam modi repellendus pariatur numquam eius incidunt quia eligendi molestias, expedita quam cupiditate fugiat dolorum. Reiciendis, blanditiis!</p>
            </div>
